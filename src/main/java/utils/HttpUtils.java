...
//                        gson.fromJson(HttpUtils.fetchData("https://random-recipes.p.rapidapi.com/ai-quotes/1"), RandomRecipesDTO[].class)
    ...
    public static Covid19DTO[] singleCovidFetch() throws IOException
    {
    ...
    public static RandomRecipesDTO[] singleRecipesFetch() throws IOException
    {
